...
/* Client-provided copy, rendered verbatim — do not edit the words; the
   TournamentGuru brand mentions linking home are the one sanctioned
   dynamic part. The route stays /terms; the page labels itself "Legal"
   per the copy. */
export default async function Page() {
  ...
  return (
    <LegalArticle
      ...
      intro={[
        <>
          Welcome to {brand}. This page outlines the legal terms, user
          responsibilities, and limitations that govern the use of our
          platform, products, and services. By accessing or using our platform,
      ...
      sections={[
        {
          ...
          paragraphs: [
            <>
              ...
              older. By using {brand}, you confirm that you meet the minimum
