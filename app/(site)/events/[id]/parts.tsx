            ...
            {event.premium &&
              ...
              event.would_return_pct > 0 && (
                <span
                  ...
                  title={`${Math.round(event.would_return_pct)}% of verified reviewers would attend again`}
                >
                  ...
                  {Math.round(event.would_return_pct)}% would attend
                </span>
              )}
          </div>
        </div>
